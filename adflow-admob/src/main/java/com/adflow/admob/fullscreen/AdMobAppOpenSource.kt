...
internal class AdMobAppOpenSource(private val context: Context) : FullScreenAdSource {
            ...
            AppOpenAd.load(
                ...
                object : AppOpenAd.AppOpenAdLoadCallback() {
                    override fun onAdLoaded(ad: AppOpenAd) {
                        ...
                        cont.resume(AdMobLoadedAppOpen(ad))
                    }
...
private class AdMobLoadedAppOpen(private val ad: AppOpenAd) : LoadedFullScreenAd {
